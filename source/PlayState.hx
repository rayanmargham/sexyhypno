...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		if (SONG == null)
			SONG = Song.loadFromJson('howtofunk');
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'cold blood':
				dialogue = CoolUtil.coolTextFile(Paths.txt('cold blood/cold bloodDialogue'));
			case 'fresh':
	...
	function startSong():Void
	{
		...
		switch(curSong)
		{
			case 'cold blood' | 'Philly' | 'Blammed' | 'Cocoa' | 'Eggnog': allowedToHeadbang = true;
	...
	*/
	...
	override function beatHit()
	{
		...
		if (curBeat % 8 == 7 && curSong == 'Bapeebo')
		{
			boyfriend.playAnim('hey', true);
		}

		if (curBeat % 16 == 15 && SONG.song == 'howtofunk' && dad.curCharacter == 'gf' && curBeat > 16 && curBeat < 48)
			{
				boyfriend.playAnim('hey', true);
